// CRITICAL: Initialize telemetry FIRST (before Claude SDK import)
// This ensures OTel auto-instrumentation can capture SDK activity
import { telemetry } from "./src/telemetry.ts";
telemetry.initialize();

// Now import Claude SDK (order matters for instrumentation)
